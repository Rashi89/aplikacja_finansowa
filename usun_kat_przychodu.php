				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="zawartosc formularz">
								...
								<form action="usun_kat_przychodu_mechanika.php" method="post">
...
$user_id=$_SESSION['id'];
												...
												<a href="#" class="akcept" data-toggle="modal" data-target="#akcept">Usuń</a>
													...
													<div class="modal-dialog modal-dialog-centered" role="document">
														<div class="modal-content">
															...
															<div class="modal-body text-center">
																	...
																	<h4>Usunięcie wybranej kategorii spowoduje usunięcie wszystkich przychodów, które były wprowadzone z&nbsp;tą kategorią! Zgadzasz się?</h4>
