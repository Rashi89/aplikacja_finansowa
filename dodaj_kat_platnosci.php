				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="zawartosc formularz">
								...
								<form action="dodaj_kat_platnosci_mechanika.php" method="post">
								
										<fieldset class="scheduler-border">
											
											<legend class="scheduler-border"> Dodanie kategorii </legend>
												
												<div cless="col-10 col-md-8 col-lg-6 col-xl-5 formularz text-center mt-5">
													<h2>Podaj nazwę nowej kategorii płatności: </h2>
													<div class="col-1 d-inline" ><i class="ikona icon-list"></i></div>
														<div class="login d-inline"><input type ="text" placeholder="Kategoria" onfocus="this.placeholder=''" onblur="this.placeholder='Kategoria'" name="new_category"></div>
														<div></div>
														<?php
															if(isset($_SESSION['error_kategoria']))
															{
																//wyrzuć error na ekran
																echo '<div class="error">'.$_SESSION['error_kategoria'].'</div>';
																//zniszcz zmienną sesyjną
																unset($_SESSION['error_kategoria']);
															}
														?>
												</div>
